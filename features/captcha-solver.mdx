...
description: "By default, infraBrowser.ai automatically solves CAPTCHAs as part of its proxy unblocking system, ensuring seamless requests."
sidebarTitle: "Captcha Handler"
---

Disabling the CAPTCHA solver keeps infraBrowser.ai’s unlocker algorithm active, handling proxy selection, headers, and fingerprinting while skipping automatic CAPTCHA solving. This gives your team a lightweight, flexible solution for broader scraping opportunities.
