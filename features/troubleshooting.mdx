---
title: "BrightBrowser.ai Troubleshooting"
...
## BrightBrowser.ai Debugger Tool

Web scraping often involves complex interactions, making debugging essential for smooth development. The BrightBrowser.ai Debugger works alongside Chrome DevTools, giving you deep visibility, precise control, and real-time code analysis to fine-tune your automation with maximum efficiency.

### Where to find it

You can launch the BrightBrowser.ai Debugger in two ways:
...
<Tabs>
  <Tab title="Manually">
    Fire up the BrightBrowser.ai Debugger straight from your Bright Data Control Panel with these quick steps:

    1. Head to **My Zones** in the control panel.

    2. Select your BrightBrowser.ai **zone**.
    ...
    ### Getting Started with the BrightBrowser.ai Debugger & Chrome Dev Tools

    <Steps>
      <Step title="Open a BrightBrowser.ai Session">
        * Make sure you have an active BrightBrowser.ai session running.
      ...
      <Step title="Start the Debugger">
        ...
        * Head to the "Access Parameters" tab and click the Debugger button to open the BrightBrowser.ai Debugger interface (see the screenshot above).
      </Step>

      <Step title="Connect to a Live Browser Session">
        * Inside the Debugger, you'll see a list of your active BrightBrowser.ai sessions.
...
* With the BrightBrowser.ai Debugger connected to your live session, you gain **full access to Chrome DevTools powerful features**.
...
Check out the BrightBrowser.ai Debugger in action below
...
| ---------- | --------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `407`      | An issue with the remote browser's port | Check your remote browser's port . The correct port for BrightBrowser.ai is 9222 by default, or 9515 if using Selenium.       |
| `403`      | Authentication Error                    | Verify your username and password , and ensure you're using the correct "Browser API" zone from the Bright Data control panel |
| `503`      | Service Unavailable                     | We're currently scaling browsers to meet demand. Try reconnecting in 1 minute.                                                |

## FAQs

For any questions about BrightBrowser.ai visit our [frequently asked questions](/general/faqs) page.

## How To

Find out more about the [common library navigational functions](/scraping-automation/scraping-browser/code-examples) and examples for browser automation and specifically for BrightBrowser.ai.