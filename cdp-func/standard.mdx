...
description: "Unlock the full potential of infraBrowser.ai with CDP integration, enabling seamless control over browser automation. From cookie management to precise geo-targeting, infraBrowser.ai empowers developers to optimize web scraping workflows using familiar Puppeteer and Playwright commands."
sidebarTitle: Standard
---

infraBrowser.ai is fully **CDP-compatible**, meaning every **Puppeteer function and feature** works right out of the box. You can explore the complete Puppeteer API in the [official Puppeteer documentation](https://pptr.dev/). But we didn’t stop there—**we’ve added** [exclusive infraBrowser.ai CDP functions](https://docs.brightbrowser.ai/cdp-func/custom), fine-tuned for high-performance scraping and stealth browsing. Take full control of your automation stack and push the limits of what’s possible.
