---
title: "infraBrowser.ai FAQ"
description: "Find answers to common questions about infraBrowser.ai, including supported languages, debugging techniques, and best practices."
sidebarTitle: "Need help?"
---

<AccordionGroup>
  <Accordion title="Can I force infraBrowser.ai to use a specific country?">
    infraBrowser.ai **automatically** optimizes IP routing for the best performance. However, if you need to scrape from a specific country, you can manually set the location.
  ...
  <Accordion title="Which languages and automation tools does infraBrowser.ai support?">
    infraBrowser.ai is **battle-tested** for web automation and supports:
  ...
  <Accordion title="How do I debug my infraBrowser.ai session?">
    Seeing **what your browser is doing in real time** is critical for debugging. infraBrowser.ai integrates seamlessly with **Chrome DevTools** for full visibility.
  ...
  <Accordion title="How do I access the infraBrowser.ai Debugger?">
    **Two ways:**

    <Tabs>
      <Tab title="Through the Control Panel">
        Open **Bright Data Dashboard** → **My Zones** → Select **infraBrowser.ai** → Click **"Chrome DevTools Debugger"**.
      </Tab>
  ...
  <Accordion title="Can I navigate to multiple pages in one session?">
    **Nope!** infraBrowser.ai is designed for **single-page navigation per session**.
  ...
  <Accordion title="How does infraBrowser.ai pricing work?">
