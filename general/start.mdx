---
title: "First steps with browser.ai"
description: "Effortless setup. Seamless automation. No roadblocks."
sidebarTitle: "Getting Started"
---

This guide will walk you through launching your first task in **browser.ai** in just a few steps—so you can start automating browser interactions at scale **without worrying about anti-bot restrictions like fingerprinting, CAPTCHAs, or IP blocks**.
...
<Steps>
  ...
  <Step title="Send you first task">
    ...
    3. _country_ - the geolocation of the task, use <Tooltip tip="For example: NO for Norway">2-letter country code</Tooltip>.
