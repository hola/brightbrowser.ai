---
title: "Configuring infraBrowser.ai"
description: "Set up infraBrowser.ai for web automation. Get your credentials, run sample scripts, and inspect live sessions effortlessly."
sidebarTitle: "Preferences"
---

## Setting Up infraBrowser.ai

Before diving into automation, let's **grab your credentials**. You’ll need your **Username and Password**, which you can find in the **Overview** tab of your infraBrowser.ai zone.
...
Run the sample code below to confirm that **infraBrowser.ai is connected and working**.
...
<Tabs>
  <Tab title="Node.js">
    <CodeGroup>
      ...
      console.log('Navigated! infraBrowser.ai...');  
      ...
      async function main() {  
          ...
          try {  
              ...
              console.log('Taking screenshot to page.png');  
              await page.screenshot({ path: './page.png', fullPage: true });  
         console.log('Navigated! infraBrowser.ai content...');  
       const html = await page.content();  
       console.log(html)   
          } finally {  
              await browser.close();  
  ...
  <Tab title="C#">
    <CodeGroup>
      ...
      Console.WriteLine("Navigated! infraBrowser.ai content...");   
...
Want a **real-time view** of your infraBrowser.ai session?
...
infraBrowser.ai is built for **serious automation** — **no CAPTCHAs, no blocks, no rate limits**.
