...
2. Create a task by either running the provided **cURL command** or sending a request to the `/tasks` endpoint with your prompt and location settings.
...
5. Once complete, retrieve the **final output** by sending a request to the `/results/{session_id}` method and recieve this output:
...
```
<Tip>Explore more in-depth information about our API [here](https://docs.browser.ai/api-reference/intro)!</Tip>