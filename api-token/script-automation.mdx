...
To use Script Automation in your **BrowserAI** tasks, just set the `engine` parameter to `Script Automation` and provide your instructions using a mix of human language inside TypeScript functions.
